...
THREE.GPUParticleContainer = function ( maxParticles, particleSystem ) {
	...
	this.spawnParticle = function ( options ) {
		...
		//var velX = 0;//velocity.x + particleSystem.random() * velocityRandomness;
		var velY = velocity.y * velocityRandomness;
		//var velZ = 0;//velocity.z + particleSystem.random() * velocityRandomness;
